...
class Helium():
    ...
    def __init__(self, **kwargs):
        ...
        self.zeeman_state = -1
        # losses
        self.two_body_polarised = 1.6 * 1e-8 # 1.6 * 1e-14 cm^-3/s
        self.three_body_polarised = 0.7 * 1e-15  # 0.7 * 1e-27 cm^-6/s
        self.two_body_unpolarised = 1.6 * 1e-4 # 1.6 * 1e-10 cm^-3/s
